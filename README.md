...
- `ObscuredFormatter<T>` — An `IMessagePackFormatter<Obscured<T>>` for serializing and deserializing `Obscured<T>` instances (serializes as a single-element array containing the plain value).
